		...
		<div class="home-doctor">
			...
			<div class="col-md-9 col-sm-12 col-lg-9">
				<div class="page-header">
				  <h3>Rent Ambulance <small>
				  <ol class="breadcrumb" style="display:inline; ">
						<span class="glyphicon glyphicon-map-marker" aria-hidden="true"></span>
						<li><a href="<?php echo base_url(); ?>index.php/ambulance/ambulanceArea/Dhaka" >Dhaka</a></li>
						<li><a href="<?php echo base_url(); ?>index.php/ambulance/ambulanceArea/Rajshahi">Rajshahi</a></li>
						<li><a href="<?php echo base_url(); ?>index.php/ambulance/ambulanceArea/Chittagong">Chittagong</a></li>
						<li><a href="<?php echo base_url(); ?>index.php/ambulance/ambulanceArea/Khulna">Khulna</a></li>
						<li><a href="<?php echo base_url(); ?>index.php/ambulance/ambulanceArea/Rangpur">Rangpur</a></li>
						<li><a href="<?php echo base_url(); ?>index.php/ambulance/ambulanceArea/Sylhet">Sylhet</a></li>
						<li><a href="<?php echo base_url(); ?>index.php/ambulance/ambulanceArea/Barishal">Barishal</a></li>
					</ol>
					</small></h3>
				</div>
...
?>
				...
				<button class="btn btn-primary" type="button">
				  Registered Ambulance <span class="badge"><?php if(isset($ambulanceamount)){ echo $ambulanceamount; } ?></span>
				</button>
				<br/>
