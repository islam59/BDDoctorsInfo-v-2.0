		...
		<div class="home-doctor">
			...
			<div class="col-md-9 col-sm-12 col-lg-9">
				<div class="page-header">
				  <h3>Pharmacy Information <small>
				  <ol class="breadcrumb" style="display:inline; ">
						<span class="glyphicon glyphicon-map-marker" aria-hidden="true"></span>
						<li><a href="<?php echo base_url(); ?>index.php/medicine/MedicineArea/Dhaka" >Dhaka</a></li>
						<li><a href="<?php echo base_url(); ?>index.php/medicine/MedicineArea/Rajshahi">Rajshahi</a></li>
						<li><a href="<?php echo base_url(); ?>index.php/medicine/MedicineArea/Chittagong">Chittagong</a></li>
						<li><a href="<?php echo base_url(); ?>index.php/medicine/MedicineArea/Khulna">Khulna</a></li>
						<li><a href="<?php echo base_url(); ?>index.php/medicine/MedicineArea/Rangpur">Rangpur</a></li>
						<li><a href="<?php echo base_url(); ?>index.php/medicine/MedicineArea/Sylhet">Sylhet</a></li>
						<li><a href="<?php echo base_url(); ?>index.php/medicine/MedicineArea/Barishal">Barishal</a></li>
					</ol>
					</small></h3>
				</div>
...
?>
				...
				<button class="btn btn-primary" type="button">
				  Pharmacy Or Medicine Shop <span class="badge"><?php if(isset($medicineamount)){ echo $medicineamount; } ?></span>
				</button>
				<br/>
